  ...
  en: {
    ...
    web: {
      hero: {
        ...
        title2: "DEVELOPER.",
        title3: "",
        description: "As an Information Technology graduate, I am seeking a challenging role as a Fullstack Developer to apply my knowledge in building real-world products while continuously advancing my technical expertise in a professional environment.",
        btnPrimary: "Explore Web Projects",
        btnSecondary: "Get in Touch",
        sysTitle: "Core Competencies",
        initMsg: "[OK] React.js, Next.js, TS/JS",
        renderMsg: "[OK] Node.js, NestJS, MySQL",
        awaitMsg: "> Docker, PHP, WordPress..."
      },
      experience: {
        title1: "WEB DEV ",
        title2: "JOURNEY.",
        description: "Tracing my growth through complex web platforms, APIs, and system designs.",
        roles: {
          role1: {
            title: "Front-End Developer Intern",
            company: "HD AGENCY",
            duration: "Feb 2025 - Apr 2025",
            desc: "Built and optimized responsive custom WordPress interfaces from Figma designs using PHP, HTML, CSS, and JS. Managed version control with Git/GitHub."
          },
          role2: {
            title: "Information Technology (B.S.)",
            company: "Thủy Lợi University",
            duration: "2021 - 2026",
            desc: "Studied core software engineering principles, algorithms, and web application architecture. GPA: 2.71/4.0."
          },
          role3: {
            title: "",
            company: "",
      ...
      projects: {
        ...
        title1: "WEB ",
        title2: "SYSTEMS.",
        viewMore: "View Web Repository →",
        modal: {
          close: "Close",
          confidentialTag: "Academic Project",
          featuresLabel: "Key Responsibilities & Features",
          downloadApk: "Live Demo",
          viewGithub: "View Source"
        },
        items: {
          proj1: {
            title: "Online Bus Ticketing System",
            desc: "An online bus ticketing platform allowing customers to search for trips, select seats, pay online, and seamlessly track booking information.",
            longDesc: "A graduation project aimed at automating the ticket booking process to reduce manual operations and enhance customer convenience. Handled full-stack development from the client UI to backend APIs and the admin dashboard.",
            features: [
              "Designed responsive UI using ReactJS and TailwindCSS.",
              "Managed global state with Redux Toolkit and server caching with React Query.",
              "Designed MySQL database and developed secure RESTful APIs with PHP.",
              "Implemented JWT authentication and integrated the VNPAY payment gateway.",
              "Built an Admin Dashboard via custom WordPress themes and plugins."
            ],
            isConfidential: false,
            apkLink: "",
            githubLink: "https://github.com/cuongtran392003",
            logoSrc: "",
            imageSrc: ""
          },
          proj2: {
  ...
  vi: {
    ...
    web: {
      hero: {
        ...
        title2: "DEVELOPER.",
        title3: "",
        description: "Là một cử nhân Công nghệ Thông tin, tôi đang tìm kiếm một vị trí đầy thử thách với vai trò Fullstack Developer. Mục tiêu của tôi là áp dụng kiến thức để phát triển các sản phẩm thực tế, đồng thời không ngừng nâng cao kỹ năng chuyên môn trong môi trường chuyên nghiệp.",
        btnPrimary: "Khám Phá Dự Án",
        btnSecondary: "Liên Hệ Ngay",
        sysTitle: "Năng lực Cốt lõi",
        initMsg: "[OK] React.js, Next.js, TS/JS",
        renderMsg: "[OK] Node.js, NestJS, MySQL",
      ...
      experience: {
        title1: "HÀNH TRÌNH ",
        title2: "PHÁT TRIỂN.",
        description: "Bản đồ đánh dấu sự phát triển chuyên môn qua các dự án Web, lập trình API và trải nghiệm thực tế.",
        roles: {
          role1: {
            title: "Thực tập sinh Front-End",
            company: "HD AGENCY",
            duration: "17/02/2025 - 17/04/2025",
            desc: "Xây dựng và tối ưu hóa giao diện WordPress tùy chỉnh (Responsive) từ thiết kế Figma bằng PHP, HTML, CSS và JavaScript. Quản lý mã nguồn với Git/GitHub."
          },
          role2: {
            title: "Cử nhân Công nghệ Thông tin",
            company: "Đại học Thủy Lợi",
            duration: "2021 - 2026",
            desc: "Nghiên cứu các nguyên lý cốt lõi của kỹ thuật phần mềm, thuật toán và kiến trúc hệ thống. Điểm trung bình (GPA): 2.71/4.0."
          },
          role3: {
            title: "",
            company: "",
      ...
      projects: {
        ...
        title1: "HỆ THỐNG ",
        title2: "WEB.",
        viewMore: "Xem Kho lưu trữ GitHub →",
        modal: {
          close: "Đóng",
          confidentialTag: "Đồ án Tốt nghiệp",
          featuresLabel: "Vai trò & Chức năng Chính",
          downloadApk: "Xem Website",
          viewGithub: "Xem Mã Nguồn"
        },
        items: {
          proj1: {
            title: "Hệ thống Đặt vé Trực tuyến",
            desc: "Nền tảng đặt vé xe khách trực tuyến cho phép khách hàng tìm kiếm chuyến đi, chọn chỗ ngồi, thanh toán trực tuyến và kiểm tra thông tin đặt vé một cách thuận tiện.",
            longDesc: "Đây là đồ án tốt nghiệp với mục tiêu tự động hóa quy trình đặt vé, giảm thiểu thao tác thủ công. Hệ thống bao gồm giao diện người dùng, backend xử lý logic và trang quản trị Admin.",
            features: [
              "Thiết kế và phát triển giao diện người dùng (Responsive) bằng ReactJS + TailwindCSS.",
              "Quản lý State Global bằng Redux Toolkit và Server State bằng React Query.",
              "Phân tích, thiết kế CSDL MySQL và xây dựng RESTful API backend bằng PHP.",
              "Tích hợp xác thực bảo mật JWT và Cổng thanh toán VNPAY.",
              "Xây dựng Admin Dashboard bằng WordPress với theme & plugin tùy chỉnh."
            ],
            isConfidential: false,
            apkLink: "",
            githubLink: "https://github.com/cuongtran392003",
